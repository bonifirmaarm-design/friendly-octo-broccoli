...
обоих из тоннеля с подъёмом в клетку, три раунда против бота, партер с работой
сверху и снизу, судья, который поднимает из затянувшейся позиции, перерыв в
углу с водой и полотенцем, награждение поясом и возврат в меню.
...
- **Игровой код ещё не написан** — есть арена и анимации, нет боевой логики,
  камеры и HUD.
- **Звука нет.**
- Судья не анимирован — рига у него нет, он перемещается. С дистанции у клетки
  это читается, вблизи будет заметно.
- Захватов и удушающих нет: партер сейчас это позиция, удары сверху, подъём и
  переворот.
